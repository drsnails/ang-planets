...
function PlanetDetailsComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate"](ctx_r0.planet.name);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate"](ctx_r0.planet.mass);
} }
...
PlanetDetailsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: PlanetDetailsComponent, selectors: [["planet-details"]], decls: 1, vars: 1, consts: [["class", "planet-details", 4, "ngIf"], [1, "planet-details"]], template: function PlanetDetailsComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](0, PlanetDetailsComponent_div_0_Template, 7, 2, "div", 0);
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx.planet);
...
function PlanetAppComponent_planet_list_3_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("planets", ctx_r2.planets);
} }
class PlanetAppComponent {
    constructor(planetService, cd) {
        this.planetService = planetService;
        this.cd = cd;
        this.currPlanetId = '';
    }
...
PlanetAppComponent.ɵfac = function PlanetAppComponent_Factory(t) { return new (t || PlanetAppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](src_app_services_planet_service__WEBPACK_IMPORTED_MODULE_2__["PlanetService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"])); };
PlanetAppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: PlanetAppComponent, selectors: [["planet-app"]], decls: 5, vars: 3, consts: [[1, "planet-app"], [4, "ngIf"], [3, "planets", "onRemovePlanet", 4, "ngIf"], [3, "planets", "onRemovePlanet"]], template: function PlanetAppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](3, PlanetAppComponent_planet_list_3_Template, 1, 1, "planet-list", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs/operators */ "kU1M");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _services_planet_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/planet.service */ "yE89");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/common */ "ofXK");
...
function ImgPreviewComponent_section_0_Template(rf, ctx) { if (rf & 1) {
    const _r2 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "section", 1);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](1, "section", 2);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function ImgPreviewComponent_section_0_Template_section_click_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r2); const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](); return ctx_r1.stopProp($event); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngStyle", _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵpureFunction1"](4, _c1, "url(" + ctx_r0.planet.imgUrl + ")"));
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
...
class ImgPreviewComponent {
    ...
    ngOnInit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            /*TEST START*/
            this.subscription = this.activatedRoute.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["mergeMap"])(params => this.planetService.getById(params.id)))
                .subscribe(planet => this.planet = planet);
            /*TEST END*/
            /*ORIGINAL START*/
...
AppHeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: AppHeaderComponent, selectors: [["app-header"]], hostBindings: function AppHeaderComponent_HostBindings(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgClass"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterLinkWithHref"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FaIconComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterLinkActive"]], styles: [".app-header[_ngcontent-%COMP%] {\n  position: fixed;\n  width: 100vw;\n  top: 0;\n  min-height: 70px;\n  background-image: linear-gradient(180deg, rgba(12, 12, 21, 0.3), rgba(12, 12, 21, 0));\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 5px;\n  z-index: 999;\n  transition: 0.2s;\n  transition-property: background-color, opacity, min-height;\n}\n.app-header.active[_ngcontent-%COMP%] {\n  background-color: #0c0c15;\n}\n.app-header[_ngcontent-%COMP%]    > h2[_ngcontent-%COMP%] {\n  margin: 0;\n  opacity: 0;\n  transform: translateY(-100%);\n}\n.app-header[_ngcontent-%COMP%]    > [_ngcontent-%COMP%]:first-child {\n  padding-left: 30px;\n}\n.app-header[_ngcontent-%COMP%]    > [_ngcontent-%COMP%]:first-child:hover {\n  text-decoration: underline;\n}\n.app-header[_ngcontent-%COMP%]    > [_ngcontent-%COMP%]:last-child {\n  padding-right: 30px;\n}\n.app-header[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  color: inherit;\n}\n.app-header[_ngcontent-%COMP%]    > a[_ngcontent-%COMP%] {\n  text-decoration: none;\n}\n.app-header[_ngcontent-%COMP%]   nav[_ngcontent-%COMP%]    > a[_ngcontent-%COMP%]:not(:last-child) {\n  margin-right: 8px;\n}\n.app-header[_ngcontent-%COMP%]   .show[_ngcontent-%COMP%] {\n  animation: scrollShow 0.5s forwards;\n}\n.app-header.hide[_ngcontent-%COMP%] {\n  min-height: 0px;\n}\n.app-header[_ngcontent-%COMP%]   .active[_ngcontent-%COMP%] {\n  color: #71b4ee;\n}\n@keyframes scrollShow {\n  0% {\n    opacity: 0;\n  }\n  50% {\n    opacity: 0;\n  }\n  100% {\n    opacity: 100;\n    transform: translateY(0);\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
class PlanetService {
    ...
    getById(planetId) {
        ...
        const { baseUrl } = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"];
        return this.http.get(`${baseUrl}/${planetId}`);
    ...
    remove(planetId) {
        ...
        const { baseUrl } = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"];
        this.http.delete(`${baseUrl}/${planetId}`).subscribe(res => {
    ...
    getPlanetImg(planetName) {
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(res => res.collection.items), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(items => {
    ...
    getPlanetsImgs() {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["forkJoin"])(planetImgs).subscribe(ball => {
